...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#08080C] flex flex-col items-center justify-center p-4 font-sans text-gray-200">
      <div className="w-full max-w-sm p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-lg">
